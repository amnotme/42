...
<head>
	...
	<style>
		body{
		background: linear-gradient(#0000, MidnightBlue), url("https://signin.intra.42.fr/assets/background_login-a4e0666f73c02f025f590b474b394fd86e1cae20e95261a6e4862c2d0faa1b04.jpg");
		}
		.img42{
			position: absolute;
			width: 12%;
				...
				<div class="col-lg-12">
					<div class="login-container">
						...
						<div class="login-main">
							<form class="simple_form form-horizontal new_user" action="accounts/create.php" method="post">
								<div class="form-inputs">
									...
									<div class="input-login login-input-group password optional user_password">
										<input class="login-control password optional" placeholder="Confirm Password" type="password" name="confpw">
									</div>
								</div>
								<div class="form-actions">
									<input class="btn btn-login" name="commit" type="submit" value="Sign up">
								</div>
							</form>
						</div>
					</div>
